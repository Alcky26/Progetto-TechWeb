...
if(!isset($_SESSION["isAdmin"],$_SESSION["email"],$_SESSION["isValid"],$_SESSION["username"])){
            ...
            if ($result != null) {
                ...
                foreach ($result as $i) {
                    ...
                    if(!in_array($i["nome"], $_SESSION["Ingredienti"])&&!in_array($i["id_ingrediente"], $_SESSION["IdIngredienti"])){
                        ...
                        <input type=\"hidden\" id=\"itemSelection\" name=\"itemSelection[".$i["id_ingrediente"]."]\"  value=\"0\" />
                        <input type=\"checkbox\" id=\"itemSelection\" name=\"itemSelection[".$i["id_ingrediente"]."]\"  value=\"1\" />
                        <input type=\"hidden\" name=\"idIng[]\" class=\"idIng\" value='".$i["id_ingrediente"]."' readonly />";
                    }
                    else{
                        $string = $string."<input type=\"text\" name=\"itemName[]\" value='".$i["nome"]."' readonly />
                        <input type=\"hidden\" id=\"itemSelection\" name=\"itemSelection[".$i["id_ingrediente"]."]\"  value=\"0\" />
                        <input type=\"checkbox\" id=\"itemSelection\" name=\"itemSelection[".$i["id_ingrediente"]."]\"  value=\"1\" checked/>
                        <input type=\"hidden\" name=\"idIng[]\" class=\"idIng\" value='".$i["id_ingrediente"]."' readonly />";
        ...
        if ($connessioneOK) 
        {
            ...
            if ($result != null) {
                ...
                foreach ($result as $i) {
                    ...
                    <input type=\"radio\" id=\"itemSelection\" name=\"itemSelection[]\" value=\"".$i["nome"]."\" />
                    </div>;";
                }
        ...
        if ($connessioneOK) 
        {
            ...
            if ($result != null) {
                ...
                foreach ($result as $i) {
                    ...
                    <input type=\"text\" name=\"itemName\" value='".$i["nome"]."' readonly />
                    <input type=\"text\" name=\"itemCateg\" value='".$i["categoria"]."' readonly />
                    <input type=\"radio\" id=\"itemSelection\" name=\"itemSelection[]\" value=\"".$i["nome"]."\" /></div>";
                }
        ...
        if ($connessioneOK) 
        {
            ...
            if ($result != null) {
                ...
                foreach ($result as $i) {
                    $string = $string."<div class=\"subsubcontaineradmin\">
                    <input type=\"text\" name=\"itemName\" value='".$i["nome"]."' readonly />
                    <input type=\"radio\" id=\"itemSelection\" name=\"itemSelection[]\" value=\"".$i["id_ingrediente"]."\" />
                    </div>";
                }
        ...
        else
        {
            ...
            if ($result != null) {
                ...
                foreach ($result as $i) {
                        $string = $string."<div class=\"subsubcontaineradmin\">
                        <input type=\"text\" name=\"itemName[]\" value='".$i["nome"]."' readonly />
                        <input type=\"hidden\" id=\"itemSelection\" name=\"itemSelection[".$i["nome"]."]\"  value=\"0\" />
                        <input type=\"checkbox\" id=\"itemSelection\" name=\"itemSelection[".$i["nome"]."]\"  value=\"1\" ".($i["disponibile"] ? "checked" : "unchecked")."/>
                        <input type=\"hidden\" id=\"itemSelectionOld\" name=\"itemSelectionOld[".$i["nome"]."]\" ".($i["disponibile"] ? "value=\"1\"" : "value=\"0\"")."/>
                        </div>";
                }
    ...
    if(isset($_POST["Annulla"])||$replace==""){
        $url="../HTML/Administrator.html";
